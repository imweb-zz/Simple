	...
	*/
    ...
    _removeAllHandlers :function( ) {
        ...
        for(id in w._allHandlers) {
            ...
            h.element.detachEvent("on" + h.eventType, h.handle);
...
(function(){
	...
	if($.cookie.get(_sname) != ''){
		$.http.loadScript(_src,function(){
			...
			init && init(document.body.appendChild($.dom.getNode('div',{style:'z-index:9999;position:absolute;bottom:24px;'})),'1');
			//放置host选择器的容器以及对应的项目id,圈子对应的项目是1
		});
	}
}).call(this);